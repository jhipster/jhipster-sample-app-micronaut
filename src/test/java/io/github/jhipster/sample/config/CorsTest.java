...
public class CorsTest {
    ...
    public void testCorsFilterOnApiPath() {
        ...
        props.put("micronaut.server.cors.configurations.default.allowed-origins", "*");
        props.put("micronaut.server.cors.configurations.default.allowed-methods", Arrays.asList("GET", "POST", "PUT", "DELETE"));
        props.put("micronaut.server.cors.configurations.default.allowed-headers", "*");
        ...
        assertThat(response.header(HttpHeaders.ACCESS_CONTROL_ALLOW_METHODS)).isEqualTo("GET,POST,PUT,DELETE");
